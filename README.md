...
> 自动发布只负责上传和填写，永远停在最终发布按钮之前。仓库中的账号凭据、浏览器状态和私有音色标识不会公开。
...
<table>
  <tr>
    <td width="50%" valign="top">
      <strong>黑金国风</strong>
      <br><br>
      <img src="./assets/demo/preview.gif" width="100%" alt="黑金国风视频演示">
    </td>
    <td width="50%" valign="top">
      <strong>水墨书法</strong>
      <br><br>
      <img src="./20260816-不争/03-成片/预览/代表帧-v9-恢复旧会话16比9手稿层.png" width="100%" alt="水墨书法视频演示">
    </td>
  </tr>
</table>

[播放水墨 24 秒视频](./20260816-不争/03-成片/不争-水墨24秒节奏版-v10-试听确认.mp4)

### 黑金国风

下面的素材来自一次完整生产流程，用于展示默认黑金国风预设；GIF 已移除复刻配音和 BGM。
...
下面是当前确认的 24 秒水墨节奏版本，包含书法背景、往返运动、水面倒影和魏碑字幕。
...
> 黑金和水墨演示中的品牌、人物与文案只代表项目预设。其他用户应替换为自己的品牌素材、授权音色、BGM 和发布账号。
